                ...
                <div class="form-example-int form-horizental mg-t-15">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                <div class="nk-int-st">
                                    <input type="text" name="qteSortie" value="{{ old('qteSortie') }}" class="form-control input-sm" placeholder="Entrer la quantité">
                                </div>
                                @error('qteSortie')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                ...
                <div class="form-example-int form-horizental">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                <div class="nk-int-st">
                                    <input type="text" name="prix" value="{{ old('prix') }}" class="form-control input-sm" placeholder="Entrer le prix du produit">
                                </div>
                                @error('prix')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
